...
namespace Pal.Client.Properties {
    ...
    internal class Localization {
        ...
        /// <summary>
        ///   Looks up a localized string similar to By default the Passage will be marked only with an outline and text label, enabling this will also enable a bright green fill..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Trap/hoard max distance.
        /// </summary>
        internal static string pnTrap_hoard_max_distance {
            get {
                return ResourceManager.GetString("pnTrap/hoard max distance", resourceCulture);
            }
        }
